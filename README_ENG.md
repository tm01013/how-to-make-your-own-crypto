...
3. [You can find out here](/.how-to-upload-to-github/upload_to_github_ENG.md) how to upload the token icon and the *tokan_metadata_github.json* file to github and get they raw they links
